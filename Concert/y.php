...
elseif($responseArray[0]["user_name"] == NULL)
{
...
<header class="heade" align = "center">
  Concert Name : <?php echo($responseArray2[0]["concertName"]); ?> <br>

  Concert Date : <?php echo($responseArray2[0]["c_date"]);?><br>

  Band : <?php echo($responseArray2[0]["BandName"]); ?><br>
  
  Ticket Number : <?php echo($responseArray1[0]["ticket_no"]);?><br>
  <br>
</header>
<style type="text/css">
  .d1
