...
<header class="heade" align = "center">
  ...
  Ticket Number: <?php if($responseArray1[0]["ticket_no"] != NULL) echo($responseArray1[0]["ticket_no"]); 
  else
   {
    echo("Not Available at the moment");
   }?><br>
  Number of tickets: <?php if($responseArray1[0]["no_of_tickets"] != NULL) echo($responseArray[0]["no_of_tickets"]); 
  else
   {
    echo("Not Available at the moment");
   }?><br><!--
